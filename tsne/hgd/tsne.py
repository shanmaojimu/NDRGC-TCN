...
# ========================== Configuration ==========================
sub = 12                                      # Subject number: 12, 8, 4, 13
tsne_file = f"tsne_test_Sub{sub:02}.csv"
...
groups = ['Left Hand', 'Right Hand', 'Feet', 'Rest']
...
# Main title
fig.suptitle('Our Method', fontsize=16)   # fontweight='bold' ; w/o N-R & PF & M-SDF
...
for group, color in sci_colors.items():
    ...
    try:
        ...
        # 68% confidence level (chi-square with 2 degrees of freedom)
